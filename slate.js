...
console.log("Developed by Tristan @ SapphireAI");
...
function startServer() {
   const privateKey = fs.readFileSync(path.join(__dirname, 'ssl/key.pem'), 'utf8');
    ...
    const httpsOptions = {
     ...
     const servers = https.createServer(httpsOptions, (req, res) => {
             res.setHeader('X-Slate-Version', '1.3');
        res.setHeader('Server', 'Slate-HTTPS')
    ...
    const server = http.createServer((req, res) => {
        res.setHeader('X-Slate-Version', '1.3');
        res.setHeader('Server', 'Slate-HTTP')
